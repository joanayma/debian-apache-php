...
j2 /root/jinja.d/apache-php7.0-fpm.conf.j2 > /etc/apache2/conf-enabled/php7.0-fpm.conf
...
j2 /root/jinja.d/php5-fpm.conf.j2 > /etc/php5/fpm/php-fpm.conf
j2 /root/jinja.d/php7.0-fpm.conf.j2 > /etc/php/7.0/fpm/php-fpm.conf
j2 /root/jinja.d/php5-fpm-pool-www.j2 > /etc/php5/fpm/pool.d/www.conf
j2 /root/jinja.d/php7.0-fpm-pool-www.j2 > /etc/php/7.0/fpm/pool.d/www.conf
#php5-memcached.j2 should be replaced by php-sessions.j2
j2 /root/jinja.d/php5-memcached.j2 > /etc/php5/fpm/conf.d/22-memcached.ini
j2 /root/jinja.d/php5-memcached.j2 > /etc/php5/apache2/conf.d/22-memcached.ini
j2 /root/jinja.d/php5-memcached.j2 > /etc/php/7.0/fpm/conf.d/22-memcached.ini
j2 /root/jinja.d/php5-memcached.j2 > /etc/php/7.0/apache2/conf.d/22-memcached.ini
j2 /root/jinja.d/php-sessions.j2 > /etc/php5/fpm/conf.d/22-custom-sessions.ini
j2 /root/jinja.d/php-sessions.j2 > /etc/php5/apache2/conf.d/22-custom-sessions.ini
j2 /root/jinja.d/php-sessions.j2 > /etc/php/7.0/fpm/conf.d/22-custom-sessions.ini
j2 /root/jinja.d/php-sessions.j2 > /etc/php/7.0/apache2/conf.d/22-custom-sessions.ini
j2 /root/jinja.d/php-newrelic.j2 > /etc/php5/fpm/conf.d/22-newrelic.ini
j2 /root/jinja.d/php-newrelic.j2 > /etc/php5/apache2/conf.d/22-newrelic.ini
j2 /root/jinja.d/php-newrelic.j2 > /etc/php/7.0/fpm/conf.d/22-newrelic.ini
j2 /root/jinja.d/php-newrelic.j2 > /etc/php/7.0/apache2/conf.d/22-newrelic.ini
j2 /root/jinja.d/php-custom-extras.j2 > /etc/php5/apache2/conf.d/22-custom-extras.ini
j2 /root/jinja.d/php-custom-extras.j2 > /etc/php5/fpm/conf.d/22-custom-extras.ini
j2 /root/jinja.d/php-custom-extras.j2 > /etc/php/7.0/apache2/conf.d/22-custom-extras.ini
j2 /root/jinja.d/php-custom-extras.j2 > /etc/php/7.0/fpm/conf.d/22-custom-extras.ini
#SCRIPTS
...
if $PHP_ENABLE_MOD; then
  ...
  if [ "x$PHP_VERSION" == "x5" ]; then
    ...
    #a2disconf php5-fpm
    #a2enconf php7.0-fpm
    echo PHP-FPM 7.0 configured via jinja
    ln -s /usr/bin/php7.0 /usr/bin/php
  else
    echo "php version $PHP_VERSION is not available"
    ln -s /usr/bin/php5 /usr/bin/php
